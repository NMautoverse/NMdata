#### this was the first .cov reader in NMdata. It will read the first
#### table in .cov. A new version was rewritten from scratch in NMdata
#### 0.2.1 that allows for selection of which table to use and by
#### default takes the last one.
