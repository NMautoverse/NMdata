...
#### get.omega.comments must return line numbers
    ...
    if("THETA"%in%auto.idx){
        ...
        elems.theta <- NMreadCtlPars(lines=lines,section="THETA",return="all",as.fun="data.table")$elements
    ...
    if("OMEGA"%in%auto.idx){
        ...
        elems.omega <- NMreadCtlPars(lines=lines,section="OMEGA",return="all",as.fun="data.table")$elements
    ...
    if("SIGMA"%in%auto.idx){
        ...
        elems.sigma <- NMreadCtlPars(lines=lines,section="SIGMA",return="all",as.fun="data.table")$elements
