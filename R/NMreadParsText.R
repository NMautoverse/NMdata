...
#### get.omega.comments must return line numbers
    ...
    if("THETA"%in%auto.idx){
        ...
        elems.theta <- NMreadCtlPars(lines=lines,section="THETA",as.fun="data.table")$elements
    ...
    if("OMEGA"%in%auto.idx){
        ...
        elems.omega <- NMreadCtlPars(lines=lines,section="OMEGA",as.fun="data.table")$elements
    ...
    if("SIGMA"%in%auto.idx){
        ...
        elems.sigma <- NMreadCtlPars(lines=lines,section="SIGMA",as.fun="data.table")$elements
